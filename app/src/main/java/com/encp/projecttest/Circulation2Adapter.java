...
import com.encp.projecttest.detail.Circulation2Detail;

import java.util.List;

public class Circulation2Adapter extends RecyclerView.Adapter<Circulation2Adapter.UpperViewHolder> {

    private Context context;
    private List<UpperItem> upperItemList;
    private int distributecount5;

    public Circulation2Adapter(Context context, List<UpperItem> upperItemList) {
    ...
    public void onBindViewHolder(UpperViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(view.getContext(), Circulation2Detail.class);
