...
public class Circulation2Detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upper2btn.setVisibility(View.GONE);
...
//                        }
//                    };
//                    Circulation2DetailRequest circulation2DetailRequest = new Upper2DetailRequest(drafter, pjcName, review, payment, recipient,
//                            title, contents, pjcGroup, nbuserName, userID, draftercount, distributecount, noticenumber, responselistener);
//                    RequestQueue queue = Volley.newRequestQueue(Circulation2Detail.this);
//                    queue.add(circulation2DetailRequest);
//                }
//            });
//        }
    }
