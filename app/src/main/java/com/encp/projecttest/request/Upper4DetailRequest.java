...
public class Upper4DetailRequest extends StringRequest {

//    final static private String URL = "http://172.30.1.33/encp/Upper4DetailRequest.php";
    final static private String URL = "http://blrioun.cafe24.com/encp/php/Upper4DetailRequest.php";
    private HashMap<String, String> parameters;

    public Upper4DetailRequest(String drafter, String pjcName, String review, String payment, String recipient,
                               String title, String contents, String pjcGroup, String nbuserName, String userID,
                               int paymentcount, int distributecount, int noticenumber, int recipientcount, Response.Listener<String> listener){
